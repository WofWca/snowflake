...
func main() {
	...
	flag.StringVar(&allowedRelayPattern, "allowed-relay-pattern", "", "allowed pattern for relay host (hostname and, optionally, port). The broker will reject proxies whose AcceptedRelayPattern is more restrictive than this")
